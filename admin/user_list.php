                                ...
                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action_btns d-flex">
                                                            <a onclick="return confirm('Are You Sure You want to Edit this Record ❌❌');" href="edituser.php?id=<?php echo $row['id']; ?>" class="action_btn mr_10"> <i
                                                                    class="far fa-edit"></i> </a>
                                                            <a onclick="return confirm('Are You Sure You want to Delete this Record ❌❌');" href="deluser.php?id=<?php echo $row['id']; ?>" class="action_btn"> <i class="fas fa-trash"></i>
                                                            </a>
                                                        </div>
                                                    </td>
                                                </tr>
